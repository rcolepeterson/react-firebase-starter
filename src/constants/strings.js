export const ABOUT = `The Town Hall app is used for crowd sourcing questions to be asked in a town hall setting.<br /><br />
  ...
  Before a company meeting, users can submit questions and vote on other user's questions.<br /><br />
  The questions are displayed in a leader board and can be sorted by the associated number of votes.<br /><br />
  ...
  All questions and voting is done in real time. Meaning, users see question vote counts go up and down as well as see new questions being asked in real time.<br /><br />
